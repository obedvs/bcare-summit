...
const cards = [
  {
    ...
    subtitle: "Oncologa",
    content:
      `"Encuentro muy útil contar con la información y el progreso de los pacientes de cancér en un solo lugar."`,
  },
  {
    asset: "/vega.webp",
    title: "Valeria Vega",
      ...
      <Swiper className="mySwiper">
        {cards.map((card, index) => (
          <SwiperSlide key={index}>
            <div className="bg-[#34A5AB] rounded-3xl absolute top-0 left-3 flex flex-col justify-evenly items-center p-4 text-white">
            ...
            <div className="bg-gradient-to-tr from-[#6DFFD6] to-[#34A5AB] rounded-3xl p-1 h-3/4">
              <div className="bg-white rounded-[20px] h-full w-full pl-[152px] md:pl-44 pr-2 flex items-center justify-center">
